...
My contribution, use as little or as much as you like. A dump of everything that came to me. This is info from a multiple time world champion so it has to be good!!! It could probably be turned into a semi reasonable powerpoint with lots of example maps. The exercises are key though. Being able to plan a good route of a certain length and being able to justify why it's good. Why you've dropped the controls you have and what options you have for adding or dropping more controls. Why your route is good etc. 
